...
wxImage SpringUnitSync::GetSidePicture( const std::string& modname, const std::string& SideName ) const
{
    wxLogDebugFunc( _T("") );
...
wxImage SpringUnitSync::GetImage( const std::string& modname, const std::string& image_path, bool useWhiteAsTransparent  ) const
{
    wxLogDebugFunc( _T("") );
...
wxImage SpringUnitSync::GetMinimap( const std::string& mapname )
{
...
wxImage SpringUnitSync::GetMinimap( const std::string& mapname, int width, int height )
{
    wxLogDebugFunc( mapname + _T(" size: ") + Tostd::string( width ) + _T("x") + Tostd::string( height ) );
...
wxImage SpringUnitSync::GetMetalmap( const std::string& mapname )
{
    wxLogDebugFunc( mapname );
...
wxImage SpringUnitSync::GetMetalmap( const std::string& mapname, int width, int height )
{
    wxLogDebugFunc( mapname + _T(" size: ") + Tostd::string( width ) + _T("x") + Tostd::string( height ) );
...
wxImage SpringUnitSync::GetHeightmap( const std::string& mapname )
{
    wxLogDebugFunc( mapname );
...
wxImage SpringUnitSync::GetHeightmap( const std::string& mapname, int width, int height )
{
    wxLogDebugFunc( mapname + _T(" size: ") + Tostd::string( width ) + _T("x") + Tostd::string( height ) );
...
wxImage SpringUnitSync::_GetMapImage( const std::string& mapname, const std::string& imagename, wxImage (SpringUnitSyncLib::*loadMethod)(const std::string&) )
{
    wxImage img;
...
wxImage SpringUnitSync::_GetScaledMapImage( const std::string& mapname, wxImage (SpringUnitSync::*loadMethod)(const std::string&), int width, int height )
{
...
namespace
{
typedef wxImage (SpringUnitSync::*LoadMethodPtr)(const std::string&);
typedef wxImage (SpringUnitSync::*ScaledLoadMethodPtr)(const std::string&, int, int);
...
void SpringUnitSync::_GetMapImageAsync( const std::string& mapname, wxImage (SpringUnitSync::*loadMethod)(const std::string&), int evtHandlerId )
{
    if (! m_cache_thread )
    {
        wxLogError( _T("cache thread not initialised") );
